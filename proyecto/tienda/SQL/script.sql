...
insert into ALMACEN.FACTURA values(ALMACEN.FACTURA_SEQ.NEXTVAL, 2, TO_DATE('01/12/2017', 'dd/mm/yyyy'), 1);
...
INSERT INTO ALMACEN.FACTURA VALUES(ALMACEN.FACTURA_SEQ.NEXTVAL, (SELECT ID FROM ALMACEN.CLIENTE WHERE NOMBRE = 'CLIENTE1'), TO_DATE('10/01/2018', 'DD/MM/YYYY'), '0');

INSERT INTO ALMACEN.DETALLE VALUES(ALMACEN.DETALLE_SEQ.NEXTVAL, 1, ALMACEN.FACTURA_SEQ.CURRVAL, (SELECT ID FROM ALMACEN.PRODUCTO WHERE NOMBRE = 'Producto1'), 12, (SELECT PRECIO FROM ALMACEN.PRODUCTO WHERE NOMBRE = 'Producto1'));
INSERT INTO ALMACEN.DETALLE VALUES(ALMACEN.DETALLE_SEQ.NEXTVAL, 2, ALMACEN.FACTURA_SEQ.CURRVAL, (SELECT ID FROM ALMACEN.PRODUCTO WHERE NOMBRE = 'Producto2'), 5, (SELECT PRECIO FROM ALMACEN.PRODUCTO WHERE NOMBRE = 'Producto2'));

INSERT INTO ALMACEN.FACTURA VALUES(ALMACEN.FACTURA_SEQ.NEXTVAL, (SELECT ID FROM ALMACEN.CLIENTE WHERE NOMBRE = 'CLIENTE1'), TO_DATE('11/01/2018', 'DD/MM/YYYY'), '0');
...
INSERT INTO ALMACEN.FACTURA VALUES(ALMACEN.FACTURA_SEQ.NEXTVAL, (SELECT ID FROM ALMACEN.CLIENTE WHERE NOMBRE = 'CLIENTE1'), TO_DATE('30/12/2017', 'DD/MM/YYYY'), '0');
...
INSERT INTO ALMACEN.FACTURA VALUES(ALMACEN.FACTURA_SEQ.NEXTVAL, (SELECT ID FROM ALMACEN.CLIENTE WHERE NOMBRE = 'CLIENTE1'), TO_DATE('30/01/2017', 'DD/MM/YYYY'), '1');
